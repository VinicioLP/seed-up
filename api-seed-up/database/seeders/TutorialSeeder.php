    ...
    public function run(): void
    {
        $tutorials = [
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=900&q=80',
                'intro' => 'A hidroponia permite cultivar folhas e ervas em pouco espaco, com controle maior de agua e nutrientes.',
                'materials' => [
            ...
            [
                ...
                'intro' => 'Uma horta simples funciona melhor quando comeca pequena, com especies resistentes e uma rotina facil.',
                'materials' => [
                    'Vasos com furos',
                    'Substrato leve',
                    'Composto organico',
            ...
            [
                ...
                'intro' => 'A rega correta depende do clima, vaso, solo e especie. O segredo e observar antes de molhar.',
                'materials' => [
